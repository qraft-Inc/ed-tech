  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Track student performance and engagement</p>
      </div>
      ...
      <div className="card text-center py-12">
        ...
        <p className="text-gray-600">Analytics will appear once students start enrolling</p>
      </div>
    </div>
  );
}
